...
var init = function init () {
  ...
  client.init(function loaded () {
	...
	, mid: client.utils.scaleMgdl(120)
    ...
    function prepareGUI () {
      ...
      val units = client.settings.units.toLowerCase();
      $('#rp_targetlow').val(targetBGdefault[units].low);
      $('#rp_targethigh').val(targetBGdefault[units].high);
      $('#rp_stricthigh').val(targetBGdefault[units].mid);
      $('#rp_superlow').val(targetBGdefault[units].superlow);
      $('#rp_superhigh').val(targetBGdefault[units].superhigh);
    ...
    function show (event) {
      ...
      options.strictLow = options.targetLow
      options.strictHigh = parseFloat($('#rp_stricthigh').val().replace(',', '.'));
      options.targetHigh = parseFloat($('#rp_targethigh').val().replace(',', '.'));
      options.ultraLow = targetBGdefault[client.settings.units.toLowerCase()].ultralow;
      options.ultraHigh = targetBGdefault[client.settings.units.toLowerCase()].ultrahigh;
    ...
    function showreports (options) {
      ...
      report_plugins.eachPlugin(function(plugin) {
        ...
        if (plugin.name == 'lotussettings' && !$('#lotussettings').hasClass('selected')) skipRender = true;
