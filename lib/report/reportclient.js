...
var init = function init () {
  ...
  client.init(function loaded () {
    ...
    function prepareGUI () {
      ...
      $('#rp_stricthigh').val(targetBGdefault[client.settings.units.toLowerCase()].mid);
    ...
    function show (event) {
      ...
      options.strictHigh = targetBGdefault[client.settings.units.toLowerCase()].mid;
