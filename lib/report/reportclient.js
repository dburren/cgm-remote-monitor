...
var init = function init () {
  ...
  client.init(function loaded () {
    ...
    function show (event) {
      ...
      options.ultraLow = val(targetBGdefault[client.settings.units.toLowerCase()].ultralow);
      options.ultraHigh = val(targetBGdefault[client.settings.units.toLowerCase()].ultrahigh);
