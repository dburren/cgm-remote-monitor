...
glucosedistribution.report = function report_glucosedistribution (datastorage, sorteddaystoshow, options) {
  ...
  $('<th colspan="8">' + translate('% of Readings') + '</th>').appendTo(thead);
  ...
  thead = $('<tr/>');
  $('<td colspan="2"></td>').appendTo(thead);
  $('<td colspan="2">' + translate('Pregnancy') + '</td>').appendTo(thead);
  $('<td>' + translate('TItR') + '</td>').appendTo(thead);
  $('<td>' + translate('TIR') + '</td>').appendTo(thead);
  thead.appendTo(table);
  ...
  ['SuperHigh', 'High', 'Elevated', 'Up', 'Normal', 'Lowish', 'Low', 'SuperLow'].forEach(function(range) {
    ...
    if (range == 'SuperHigh') {
      ...
      $('<td rowspan="4"></td>').appendTo(tr);
      $('<td rowspan="3" colspan="2"></td>').appendTo(tr);
      $('<td rowspan="2"></td>').appendTo(tr);
      $('<td class="tdborder" rowspan="2">' + tar2.toFixed(1) + '%</td>').appendTo(tr);
      $('<td class="tdborder" rowspan="3">' + tar3.toFixed(1) + '%</td>').appendTo(tr);
    ...
    if (range == 'Up') {
      $('<td class="tdborder">' + r.readingspct.toFixed(1) + '%</td>').appendTo(tr);
      $('<td class="tdborder" rowspan="3">' + preg2.toFixed(1) + '%</td>').appendTo(tr);
      $('<td class="tdborder" rowspan="2"><strong>' + titr.toFixed(1) + '%</strong></td>').appendTo(tr);
      $('<td rowspan="3"></td>').appendTo(tr);
    } 
    if (range == 'Normal') {
    ...
    if (range == 'Low') {
      $('<td class="tdborder"><strong>' + r.readingspct.toFixed(1) + '%</strong></td>').appendTo(tr);
      $('<td rowspan="2" colspan="2"></td>').appendTo(tr);
      $('<td class="tdborder" rowspan="2"><strong>' + tbr1.toFixed(1) + '%</strong></td>').appendTo(tr);
    }
    if (range == 'SuperLow') {
      $('<td class="tdborder"><strong>' + r.readingspct.toFixed(1) + '%</strong></td>').appendTo(tr);
    } 
  ...
  if (glucose_data.length > 0) {
    ...
    var predtr = $('<tr>');
    $('<td>' + translate('Weighted') + '</td>').appendTo(tr);
    ...
    predtr = $('<tr>');
    $('<td>' + translate('Mean') + '</td>').appendTo(tr);
