...
glucosedistribution.report = function report_glucosedistribution (datastorage, sorteddaystoshow, options) {
  ...
  var tir = (Number(titr) + Number(result.Elevated.readingspct)).tofixed(1);
  ...
  var tar2 = tar2.toFixed(1);
  var tar3 = tar3.toFixed(1);
  var tar4 = tar4.toFixed(1);
  var preg1 = preg1.toFixed(1);
  var preg2 = preg2.toFixed(1);
  var preg3 = preg3.toFixed(1);
  var titr = titr.toFixed(1);
  var tir = tir.toFixed(1);
  var tbr1 = tbr1.toFixed(1);
  var tbr2 = tbr2.toFixed(1);
  var tbr3 = tbr3.toFixed(1);
