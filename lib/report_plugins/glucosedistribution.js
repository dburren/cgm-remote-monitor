...
glucosedistribution.report = function report_glucosedistribution (datastorage, sorteddaystoshow, options) {
  ...
  if (glucose_data.length > 0) {
    ...
    if (!extra || (a1cmd === a1cwd && a1cmi === a1cwi && gmim == gmiw)) {
      ...
      $('<td class="tdborder"><center><strong>' + a1cmd + '&nbsp;% ' + a1cmi + '&nbsp;mmol/mol</strong></center></td>').appendTo(predtr);
      $('<td class="tdborder"><center>' + gmim + '&nbsp;% ' + gmimi + '&nbsp;mmol/mol</center></td>').appendTo(predtr);
      ...
      $('<td class="tdborder"><center>' + gmim + '%<sub>DCCT</sub> ' + gmimi + '<sub>IFCC</sub></center></td>').appendTo(predtr);
      predtable.append(predtr);
      preds.append(predtable);
      ...
      $('<td class="tdborder"><center>' + gmiw + '%<sub>DCCT</sub> ' + gmiwi + '<sub>IFCC</sub></center></td>').appendTo(predtr);
      predtable.append(predtr);
      preds.append(predtable);
    }
  } else {
