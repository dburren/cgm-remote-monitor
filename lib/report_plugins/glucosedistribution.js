...
glucosedistribution.report = function report_glucosedistribution (datastorage, sorteddaystoshow, options) {
  ...
  ['SuperHigh', 'High', 'Elevated', 'Up', 'Normal', 'Lowish', 'Low', 'SuperLow'].forEach(function(range) {
    ...
    $('<td class="tdborder" style="background-color:' + tablecolors[range] + '"><strong>' + translate(rangeLabel) + ':</strong><br/><font size="-2">' + rangeExp + '</font></td>').appendTo(tr);

    if (range == 'SuperHigh') {
      $('<td class="tdborder">' + r.readingspct.toFixed(1) + '%</td>').appendTo(tr);
      $('<td class="tdborder" rowspan="4">' + tar4desc + '<br/>' + tar4.toFixed(1) + '%</td>').appendTo(tr);
      $('<td class="tdborder" colspan="2" rowspan="3">' + tar3desc + '<br/>' + tar3.toFixed(1) + '%</td>').appendTo(tr);
      $('<td class="tdborder" rowspan="2">' + tar2desc + '<br/>' + tar2.toFixed(1) + '%</td>').appendTo(tr);
    }
    if (range == 'High') {
      $('<td class="tdborder">' + r.readingspct.toFixed(1) + '%</td>').appendTo(tr);
      //if (!!haveAbove) {
    ...
    if (range == 'Elevated') {
      $('<td class="tdborder">' + r.readingspct.toFixed(1) + '%</td>').appendTo(tr);
      $('<td class="tdborder" rowspan="3">' + translate('TIR') + '<br/><strong>' + tir.toFixed(1) + '%</strong></td>').appendTo(tr);
      //if (!!haveStrict) {
    ...
    if (range == 'Up') {
      ...
      $('<td class="tdborder" rowspan="2">' + translate('TItR') + '<br/><strong>' + titr.toFixed(1) + '%</strong></td>').appendTo(tr);
    } 
    if (range == 'Normal') {
    ...
    if (range == 'Lowish') {
      $('<td class="tdborder">' + r.readingspct.toFixed(1) + '%</td>').appendTo(tr);
      $('<td class="tdborder" rowspan="2"><table id="fullheight"><tr><td class="tdborder">' + tbr3.toFixed(1) + '%</td></tr><tr><td class="tdborder" valign="bottom">' + tbr3desc + '</td></tr></table></td>').appendTo(tr);
      $('<td class="tdborder" rowspan="3">' + tbr2desc + '<br/><strong>' + tbr2.toFixed(1) + '%</strong></td>').appendTo(tr);
    }
    if (range == 'Low') {
      $('<td class="tdborder">' + r.readingspct.toFixed(1) + '%</td>').appendTo(tr);
      $('<td class="tdborder" colspan="2" rowspan="2">' + tbr1desc + '<br/><strong>' + tbr1.toFixed(1) + '%</strong></td>').appendTo(tr);
    }
    if (range == 'SuperLow') {
      $('<td class="tdborder">' + r.readingspct.toFixed(1) + '%</td>').appendTo(tr);
      $('<td></td>').appendTo(tr);
