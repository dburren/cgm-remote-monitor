...
glucosedistribution.report = function report_glucosedistribution (datastorage, sorteddaystoshow, options) {
  ...
  val tar2 = result.SuperHigh.readingspct + result.High.readingspct;
  val tar3 = result.Elevated.readingspct + tar2;
  val tar4 = result.Up.readingspct + tar2;
  val preg1 = result.Normal.readingspct + result.Lowish.readingspct;
  val preg2 = result.Up.readingspct + preg1;
  val titr = result.Normal.readingspct + result.Up.readingspct;
  val tir = titr + result.Elevated.readingspct;
  val tbr1 = result.Low.readingspct + result.SuperLow.readingspct;
  val tbr1desc = '<' + options.superLow;
  val tbr2 = tbr1 + result.Lowish.readingspct;
  val tbr2desc = '<' + options.targetLow;
  val tbr3 = result.Low.readingspct + result.Lowish.readingspct;
  val tbr3desc = '>=' + options.ultraLow + ',&nbsp;<' + options.targetLow;
  ...
  ['SuperHigh', 'High', 'Elevated', 'Up', 'Normal', 'Lowish', 'Low', 'SuperLow'].forEach(function(range) {
    ...
    if (range == 'SuperHigh') {
      ...
      $('<td class="tdborder" colspan="2" rowspan="3">' + tar3.toFixed(1) + '%</td>').appendTo(tr);
    ...
    if (range == 'High') {
      ...
      //if (!!haveAbove) {
        ...
        //}
        //$('<td></td>').appendTo(tr);
        //$('<td class="tdborder" rowspan="2">' + tar.toFixed(1) + '%</td>').appendTo(tr);
      //} else {
        //if (!!haveStrict) {
          //$('<td></td>').appendTo(tr);
	//}
    ...
    if (range == 'Elevated') {
      $('<td class="tdborder">' + r.readingspct.toFixed(1) + '%</td>').appendTo(tr);
      $('<td class="tdborder" rowspan="3"><strong>' + translate('TIR') + '<br/>' + tir.toFixed(1) + '%</strong></td>').appendTo(tr);
      //if (!!haveStrict) {
        //$('<td class="tdborder" rowspan="3"><strong>' + tir.toFixed(1) + '%</strong></td>').appendTo(tr);
      //} else {
        //$('<td class="tdborder" rowspan="2"><strong>' + tir.toFixed(1) + '%</strong></td>').appendTo(tr);
      //}
    } 
    if (range == 'Up') {
      $('<td class="tdborder">' + r.readingspct.toFixed(1) + '%</td>').appendTo(tr);
      $('<td class="tdborder" rowspan="3">' + translate('Preg') + '<br/>' + preg2.toFixed(1) + '%</td>').appendTo(tr);
      $('<td class="tdborder" rowspan="2"><strong>' + translate('TItR') + '<br/>' + titr.toFixed(1) + '%</strong></td>').appendTo(tr);
    } 
    if (range == 'Normal') {
    ...
    if (range == 'Lowish') {
      $('<td class="tdborder">' + r.readingspct.toFixed(1) + '%</td>').appendTo(tr);
      $('<td class="tdborder" rowspan="2">' + tbr3desc + '<br/>' + tbr3.toFixed(1) + '%</td>').appendTo(tr);
      $('<td class="tdborder" rowspan="3"><strong>' + tbr2desc + '<br/>' + tbr2.toFixed(1) + '%</strong></td>').appendTo(tr);
    }
    if (range == 'Low') {
      $('<td class="tdborder">' + r.readingspct.toFixed(1) + '%</td>').appendTo(tr);
      $('<td class="tdborder" colspan="2" rowspan="2"><strong>' + tbr1desc + '<br/>' + tbr1.toFixed(1) + '%</strong></td>').appendTo(tr);
    }
    if (range == 'SuperLow') {
      $('<td class="tdborder">' + r.readingspct.toFixed(1) + '%</td>').appendTo(tr);
      $('<td></td>').appendTo(tr);
