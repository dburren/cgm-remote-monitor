...
glucosedistribution.report = function report_glucosedistribution (datastorage, sorteddaystoshow, options) {
  ...
  var five_data.weighted = wtotal / wdivisor;
  ...
  var flat_data.weighted = wtotal / wdivisor;
  ...
  var interp_data.weighted = wtotal / wdivisor;
  ...
  if (glucose_data.length > 0) {
    ...
    let flata1c_weighted = (flatweighted + 46.7) / 28.7;
    ...
    let flatgmiwf = flatweighted * 0.02392 + 3.31;
    ...
    let interpa1c_weighted = (interpweighted + 46.7) / 28.7;
    ...
    let interpgmiwf = interpweighted * 0.02392 + 3.31;
