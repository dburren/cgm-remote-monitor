...
glucosedistribution.report = function report_glucosedistribution (datastorage, sorteddaystoshow, options) {
  ...
  if (glucose_data.length > 0) {
    ...
    if (!extra || (a1cmd === a1cwd && a1cmi === a1cwi && gmim == gmiw)) {
      ...
      $('<td class="tdborderl"><strong>' + a1cmd + '<sub>&nbsp;%</sub>&nbsp;(' + mina1cmd + '<sub>%nbsp;%</sub>) ' + a1cmi + '<sub>&nbsp;mmol/mol</sub>&nbsp;(' + minna1mi + '<sub>&nbsp;mmol/mol</sub></strong></td>').appendTo(predtr);
      ...
      $('<td class="tdborderl">' + a1cmd + '<sub>&nbsp;%</sub>&nbsp;(' + mina1cmd + '<sub>%nbsp;%</sub>) ' + a1cmi + '<sub>&nbsp;mmol/mol</sub>&nbsp;(' + minna1mi + '<sub>&nbsp;mmol/mol</sub></td>').appendTo(predtr);
      $('<td class="tdborderl">' + gmim + '<sub>&nbsp;%</sub>&nbsp;(' + mingmim + '<sub>%nbsp;%</sub>) ' + gmimi + '<sub>&nbsp;mmol/mol</sub>&nbsp;(' + mingmimi + '<sub>&nbsp;mmol/mol</sub></td>').appendTo(predtr);
      predtable.append(predtr);
      preds.append(predtable);
      ...
      $('<td class="tdborderl"><strong>' + a1cwd + '<sub>&nbsp;%</sub>&nbsp;(' + mina1cwd + '<sub>%nbsp;%</sub>) ' + a1cwi + '<sub>&nbsp;mmol/mol</sub>&nbsp;(' + minna1wi + '<sub>&nbsp;mmol/mol</sub></strong></td>').appendTo(predtr);
