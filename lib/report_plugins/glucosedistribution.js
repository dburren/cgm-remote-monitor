  ...
  ['SuperHigh', 'High', 'Elevated', 'Up', 'Normal', 'Lowish', 'Low', 'SuperLow'].forEach(function(range) {
    ...
    if (range == 'SuperHigh') {
      ...
      if (tar2count > 0) {
        ...
        $('<td rowspan="' + tar2count + '"></td>').appendTo(tr);
      }
      if (tar3count > 0) {
        $('<td class="tdborder" rowspan="' + tar3count + '" colspan="2">' + tar3.toFixed(1) + '%</td>').appendTo(tr);
      } else {
        $('<td rowspan="' + tar3count + '" colspan="2"></td>').appendTo(tr);
      }
      if (tar4count > 0) {
        $('<td class="tdborder" rowspan="' + tar4count + '">' + tar4.toFixed(1) + '%</td>').appendTo(tr);
      } else {
        $('<td rowspan="' + tar4count + '"></td>').appendTo(tr);
      }
    }
    if (range == 'High') {
      $('<td class="tdborder">' + r.readingspct.toFixed(1) + '%</td>').appendTo(tr);
    ...
    if (range == 'Elevated') {
      ...
      if (tircount > 0) {
        ...
        $('<td rowspan="' + tircount + '"></td>').appendTo(tr);
      }
    } 
    if (range == 'Up') {
      $('<td class="tdborder">' + r.readingspct.toFixed(1) + '%</td>').appendTo(tr);
      if (titrcount > 0) {
        ...
        $('<td rowspan="' + titrcount + '"></td>').appendTo(tr);
      }
    ...
    if (range == 'Low') {
      $('<td class="tdborder">' + r.readingspct.toFixed(1) + '%</td>').appendTo(tr);
      $('<td class="tdborder" colspan="2" rowspan="' + tbr1count + '"><strong>' + tbr1.toFixed(1) + '%</strong></td>').appendTo(tr);
    }
    if (range == 'SuperLow') {
      $('<td class="tdborder">' + r.readingspct.toFixed(1) + '%</td>').appendTo(tr);
      $('<td></td>').appendTo(tr);
