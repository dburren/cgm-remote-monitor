...
daytoday.report = function report_daytoday (datastorage, sorteddaystoshow, options) {
  ...
  function drawChart (day, data, options) {
    ...
    if (options.insulindistribution) {
      ...
      var table = $('<table>');
      $('<tr><td><b>' + translate('Bolus insulin:') + '</b></td><td align="right">' + bolusInsulin.toFixed(3) + 'U</td></tr>').appendTo(table);
      ...
      var chartData = [
        ...
        , { label: translate('non-default insulin'), count: (totalDailyInsulin-baseBasalInsulin), pct: ((totalDailyInsulin-baseBasalInsulin) / totalDailyInsulin * 100).toFixed(0) }
      ];
