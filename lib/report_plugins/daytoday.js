...
daytoday.report = function report_daytoday (datastorage, sorteddaystoshow, options) {
  ...
  if (options.insulindistribution) {
    ...
    // html += '<b>' + translate('Hypos total') + ':</b> ' + hypoSum;
  ...
  function drawChart (day, data, options) {
    ...
    if (options.insulindistribution) {
      ...
      var table = $('<table>');
      $('<tr><td><b>' + translate('Bolus insulin:') + '</b></td><td align="right">' + bolusInsulin.toFixed(2) + 'U</td></tr>').appendTo(table);
      if (positiveTemps > 0 || negativeTemps > 0) {
        $('<tr><td>' + translate('Base basal insulin:') + '</td><td align="right">' + baseBasalInsulin.toFixed(2) + 'U</td></tr>').appendTo(table);
      }
      if (positiveTemps > 0) {
      ...
      $('<tr><td><b>' + translate('Total basal insulin:') + '</b></td><td align="right">' + totalBasalInsulin.toFixed(2) + 'U</td></tr>').appendTo(table);
