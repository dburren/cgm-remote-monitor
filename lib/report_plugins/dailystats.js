...
dailystats.report = function report_dailystats (datastorage, sorteddaystoshow, options) {
  ...
  $('<th style="background-color:#ff8">' + translate('Low') + '</th>').appendTo(thead);
  if (options.superLow < options.targetLow) {
    $('<th style="background-color:#fb0">' + translate('Lowish') + '</th>').appendTo(thead);
  }
  $('<th style="background-color:#8f8">' + translate('Normal') + '</th>').appendTo(thead);
  if (options.targetHigh < options.superHigh) {
    $('<th style="background-color:#cf0">' + translate('Highish') + '</th>').appendTo(thead);
  }
  $('<th style="background-color:#f88">' + translate('High') + '</th>').appendTo(thead);
  ...
  sorteddaystoshow.forEach(function(day) {
    ...
    $('<td class="tdborder">' + ss.standard_deviation(bgValues).toFixed(1) + '\n(' +
