...
dailystats.report = function report_dailystats (datastorage, sorteddaystoshow, options) {
  ...
  if (options.superLow < options.targetLow) {
    $('<th style="background-color:#fb0">' + translate('Lowish') + '<font size="-1"><br/>' + options.superLow.toFixed(1) + '&nbsp;&nbsp;&nbsp;&nbsp;</font></th>').appendTo(thead);
  }
  $('<th style="background-color:#8f8">' + translate('In Range') + '<font size="-1"><br/>' + options.targetLow.toFixed(1) + '&nbsp;&nbsp;&nbsp;&nbsp;' + options.targetHigh.toFixed(1) + '</font></th>').appendTo(thead);
