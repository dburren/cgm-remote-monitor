...
dailystats.report = function report_dailystats (datastorage, sorteddaystoshow, options) {
  ...
  if (options.superLow < options.targetLow) {
    $('<th style="background-color:#fb0">' + translate('Lowish') + '<font size="-1"><br/><div style="float:left;">&nbsp;' + options.superLow + '</div></font></th>').appendTo(thead);
  }
  $('<th style="background-color:#8f8">' + translate('In Range') + '<font size="-1"><br/><div style="float:left;">&nbsp;' + options.targetLow + '</div><div style="float:right;">' + options.targetHigh + '&nbsp;</div></font></th>').appendTo(thead);
  if (options.targetHigh < options.superHigh) {
    $('<th style="background-color:#cf0">' + translate('Highish') + '<font size="-1"><br/><div style="float:right;">' + options.superHigh + '&nbsp;</div></font></th>').appendTo(thead);
  }
