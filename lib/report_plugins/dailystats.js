...
dailystats.report = function report_dailystats (datastorage, sorteddaystoshow, options) {
  ...
  $('<th style="background-color:#ff0000">' + translate('Low') + '<br />&nbsp;</th>').appendTo(thead);
  if (options.superLow < options.targetLow) {
    $('<th style="background-color:#ff9966">' + translate('Lowish') + '<font size="-1"><br/><div style="float:left;">&nbsp;' + options.superLow + '</div></font></th>').appendTo(thead);
  }
  $('<th style="background-color:#3deb3d">' + translate('In Range') + '<font size="-1"><br/><div style="float:left;">&nbsp;' + options.targetLow + '</div><div style="float:right;">' + options.targetHigh + '&nbsp;</div></font></th>').appendTo(thead);
  if (options.targetHigh < options.superHigh) {
    $('<th style="background-color:#00ae00">' + translate('Highish') + '<font size="-1"><br/><div style="float:right;">' + options.superHigh + '&nbsp;</div></font></th>').appendTo(thead);
  }
  $('<th style="background-color:#00ffff">' + translate('High') + '<br />&nbsp;</th>').appendTo(thead);
